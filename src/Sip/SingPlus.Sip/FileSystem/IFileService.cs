...
[BoundedPayload(512)] public readonly record struct OpenFileRequestV2(CapabilityHandleV2 NamespaceCapability, string Path, bool Create) : IBoundedPayload { public int PayloadSize => 64 + (Path?.Length ?? 0) * 2; public int MaxPayloadSize => 512; }
...
public interface IFileService
{
    ...
    [Message(5), Transition("Ready", "Ready")] ValueTask<FileObjectResponse> OpenV2Async(OpenFileRequestV2 request);
}
