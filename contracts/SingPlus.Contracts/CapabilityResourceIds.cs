...
public static class CapabilityResourceIds
{
    ...
    public const string CompositorPresent = "compositor:present:v1";
    public const string WindowManagement = "window-manager:manage:v1";
    public const string InputEvents = "input:normalized-events:v1";
    public const string ClipboardSession = "clipboard:session:v1";
    public const string FontTextLayout = "font-text:layout:v1";
    public const string AccessibilityTree = "accessibility:tree:v1";
    public const string NotificationPost = "notification:post:v1";
    public const string ShellSession = "shell:session:v1";

    public static string Process(ProcessHandle process) =>
        $"process:{process.ProcessId.Value}:{process.Generation}:v1";
    public static string FileObject(EndpointSessionHandle session, ulong objectId) =>
        $"file-object:{session.SessionId.Value}:{session.Generation.Value}:{objectId}:v1";

    public static string SocketObject(EndpointSessionHandle session, ulong objectId) =>
        $"socket-object:{session.SessionId.Value}:{session.Generation.Value}:{objectId}:v1";
