...
public readonly record struct MutationEpoch(ulong Value);
public readonly record struct RegionUseId(ulong Value);
public readonly record struct RegionUseHandle(RegionUseId UseId, ulong Generation);
