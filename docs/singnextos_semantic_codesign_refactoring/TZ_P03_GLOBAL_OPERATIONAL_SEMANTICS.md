# ТЗ P03 — Define global composition and irreversible boundary

**Depends on:** P02.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.

## CD-P03-01 — Specify GlobalState and owner transitions
...
- **Verified current anchors:** `src/Runtime/SingPlus.Runtime/VNext/ResourceAdmissionProtocol.cs; src/Runtime/SingPlus.Runtime/ExternalOperations/ExternalOperationAuthority.cs; src/Runtime/SingPlus.Runtime/Services/EndpointSessionInvocationRegistry.cs; src/Runtime/SingPlus.Runtime/Regions/RegionAuthority.cs`.
- **Proposed surface:** GlobalOperationModel spec, IrreversibleBoundaryClass.
...
- **Dependencies/blockers:** P02; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
...
## CD-P03-03 — TLA+/PlusCal model for revoke/reserve/session/Region/provider races
