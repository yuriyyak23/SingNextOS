# ТЗ P15 — Close TCB/bootstrap/durable authority follow-ups and decide IFC scope

**Depends on:** P14.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.

## CD-P15-01 — specify managed execution assumptions/evidence
...
- **Verified current anchors:** `tools/SingPlus.Admission/AdmissionVerifier.cs; src/Runtime/SingPlus.Runtime/Checkpointing/RuntimeKernel.Checkpointing.cs; src/Runtime/SingPlus.Runtime/Capabilities/CapabilityAuthority.cs`.
- **Proposed surface:** ManagedExecutionContractV1, BootAuthorityPolicy document/contract, DurableAuthorityReconstructionRequest, IFC decision record.
...
- **Dependencies/blockers:** P14; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
...
## CD-P15-02 — define boot/service root mint policy using existing CapabilityAuthority
...
## CD-P15-04 — decide IFC: defer unless cross-domain confidentiality thesis requires labels
