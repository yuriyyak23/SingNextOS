# P12 — Close replay/determinism/provider refinement/isolation/contention/locality semantics

## 1. Goal
Close replay/determinism/provider refinement/isolation/contention/locality semantics.

## 2. Rationale / live gap
- HybridCPU replay policy is already non-authoritative.
- provider-neutrality needs explicit semantic refinement.
...
- **VERIFIED_EXISTING:** `HybridCPU_ExternalRuntime.Contracts/ExternalOperationReplayContracts.cs`
...
- **VERIFIED_EXISTING:** `src/Runtime/SingPlus.Runtime/Platform/PlatformAuthorityBridge.ExecutionPolicy.cs`

## 6. NEW_PROPOSED surfaces
- **NEW_PROPOSED:** `ProviderBehaviorContractV1`
- **NEW_PROPOSED:** `DeterminismClassV1`
- **NEW_PROPOSED:** `IsolationClassSetV1`
- **NEW_PROPOSED:** `ContentionGuaranteeV1`
...
- Alloy/provider refinement counterexample search.
