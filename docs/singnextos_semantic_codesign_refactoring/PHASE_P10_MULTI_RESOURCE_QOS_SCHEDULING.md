# P10 — Add atomic multi-resource admission and separate permission/reservation/scheduling/guarantees

## 1. Goal
Add atomic multi-resource admission and separate permission/reservation/scheduling/guarantees.

## 2. Rationale / live gap
- current end-to-end contour is ComputeTime only.
- reservation is not scheduling or minimum/deadline guarantee.
...
- **VERIFIED_EXISTING:** `src/Runtime/SingPlus.Runtime/VNext/ResourceScheduler.cs`
- **VERIFIED_EXISTING:** `src/Runtime/SingPlus.Runtime/VNext/ResourceAdmissionProtocol.cs`

## 6. NEW_PROPOSED surfaces
- **NEW_PROPOSED:** `ResourceEnvelopeSetV1`
- **NEW_PROPOSED:** `AtomicResourceReservation`
- **NEW_PROPOSED:** `ServiceGuaranteeClaimV1`
...
- TLA+/PlusCal multi-resource deadlock/conservation model.
