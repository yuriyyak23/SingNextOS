# P03 — Define global composition and irreversible boundary

## 1. Goal
Define global composition and irreversible boundary.

## 2. Rationale / live gap
- local state machines exist, but global composition must be explicit.
...
- **NEW_PROPOSED:** `GlobalOperationModel spec`
- **NEW_PROPOSED:** `IrreversibleBoundaryClass`
...
- TLA+/PlusCal global composition model.
