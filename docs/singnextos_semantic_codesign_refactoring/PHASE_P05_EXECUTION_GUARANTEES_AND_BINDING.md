# P05 — Add ExecutionGuarantees and exact SemanticExecutionBinding across provider boundary

## 1. Goal
Add ExecutionGuarantees and exact SemanticExecutionBinding across provider boundary.

## 2. Rationale / live gap
- HybridCPU has exact request/admission binding but no complete guarantee descriptor.
- avoid collision with SecureExecutionBinding.
...
- **NEW_PROPOSED:** `ExecutionGuaranteesV1`
- **NEW_PROPOSED:** `SemanticExecutionBinding`
- **NEW_PROPOSED:** `ExecutionContractVersion`
- **NEW_PROPOSED:** `GuaranteeObservationReceipt`
...
- Alloy identity/version binding checks.
