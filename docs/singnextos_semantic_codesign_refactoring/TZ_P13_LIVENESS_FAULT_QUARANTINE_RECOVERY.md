# ТЗ P13 — Make safety/liveness/fault assumptions explicit and bound quarantine where possible

**Depends on:** P12.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.
...
- **Verified current anchors:** `src/Runtime/SingPlus.Runtime/ExternalOperations/ExternalOperationAuthority.cs; src/Runtime/SingPlus.Runtime/VNext/ExternalOperationResourceBinding.cs; HybridCPU_ExternalRuntime/HybridCpuExternalRuntime.cs; src/Runtime/SingPlus.Runtime/Checkpointing/RuntimeKernel.Checkpointing.cs`.
- **Proposed surface:** ProviderTrustClassV1, FaultModelV1, QuarantinePolicyV1, ReconciliationJournal interface if persistence is required.
...
- **Dependencies/blockers:** P12; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
