# P18 — Formal/adversarial qualification, feature promotion, docs synchronization and cutover

## 1. Goal
Formal/adversarial qualification, feature promotion, docs synchronization and cutover.

## 2. Rationale / live gap
- no claim should exceed exact source/provider/runtime/test evidence.
- existing feature gates are all OFF.
...
- **VERIFIED_EXISTING:** `src/Runtime/SingPlus.Runtime/VNext/VNextFeatureGates.cs`
- **VERIFIED_EXISTING:** `tests/SingPlus.Tests/Runtime/SingCapPhase13CrossAuthorityRaceTests.cs`
- **VERIFIED_EXISTING:** `HybridCPU_ExternalRuntime.Tests/ExternalOperationContractTests.cs`

## 6. NEW_PROPOSED surfaces
- **NEW_PROPOSED:** `CoDesignQualificationTupleV1`
- **NEW_PROPOSED:** `co-design feature gates`
- **NEW_PROPOSED:** `promotion checklist`
...
- run and archive all applicable formal models.
