# ТЗ P00 — Live baseline, source/package freeze and executable inventory

**Depends on:** none.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.

## CD-P00-01 — Freeze exact SHAs and tree SHAs
...
- **Verified current anchors:** `global.json; contracts/SingPlus.Contracts/SingPlus.Contracts.csproj; src/Runtime/SingPlus.Runtime/SingPlus.Runtime.csproj; HybridCPU_ExternalRuntime.Contracts/HybridCPU_ExternalRuntime.Contracts.csproj`.
- **Proposed surface:** QualificationTupleV2, semantic co-design baseline manifest.
...
- **Dependencies/blockers:** none; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
...
## CD-P00-02 — Recompute package/DLL hashes and lockfile identity
...
## CD-P00-03 — Inventory relevant tests/contracts and record current pass/fail baseline
