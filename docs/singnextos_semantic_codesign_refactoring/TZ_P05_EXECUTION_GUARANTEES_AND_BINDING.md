# ТЗ P05 — Add ExecutionGuarantees and exact SemanticExecutionBinding across provider boundary

**Depends on:** P04.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.

## CD-P05-01 — Add provider-neutral guarantee descriptor
...
- **Verified current anchors:** `src/Runtime/SingPlus.Runtime/ExternalOperations/HybridCpuExternalOperationProvider.cs; HybridCPU_ExternalRuntime.Contracts/ExternalOperationAdmissionBindingContracts.cs; HybridCPU_ExternalRuntime.Contracts/ExternalOperationAdapterContracts.cs; HybridCPU_ISE/CloseToHSL/Core/Pipeline/Safety/SafetyVerifier.Types.cs`.
- **Proposed surface:** ExecutionGuaranteesV1, SemanticExecutionBinding, ExecutionContractVersion, GuaranteeObservationReceipt.
...
- **Dependencies/blockers:** P04; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
...
## CD-P05-02 — Bind exact OS operation/provider generations/contracts
...
## CD-P05-03 — Add conservative compatibility mapping for 1.14.0
...
## CD-P05-04 — Cross-repo API baseline/conformance tests
