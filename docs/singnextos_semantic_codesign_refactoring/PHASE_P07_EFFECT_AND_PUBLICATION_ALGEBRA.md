# P07 — Generalize effect/publication semantics without collapsing completion/visibility/publication

## 1. Goal
Generalize effect/publication semantics without collapsing completion/visibility/publication.

## 2. Rationale / live gap
- current external effect classes are useful but too coarse for network/MMIO/storage/RPC/durable effects.
...
- **NEW_PROPOSED:** `EffectSemanticsV1`
- **NEW_PROPOSED:** `PublicationSemanticsV1`
- **NEW_PROPOSED:** `PublicationDecisionRecord`
...
- finite-state effect/publication lifecycle exploration.
