# ТЗ P04 — Implement SingNext OperationObligations as non-authoritative semantic snapshot

**Depends on:** P03.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.

## CD-P04-01 — Add versioned obligation DTO vocabulary
...
- **Verified current anchors:** `contracts/SingPlus.Contracts/ComputePlanning.cs; contracts/SingPlus.Contracts/ExternalOperations.cs; contracts/SingPlus.Contracts/ResourceControlModelContracts.cs; src/Runtime/SingPlus.Runtime/Regions/RegionAuthority.cs`.
- **Proposed surface:** OperationObligationsV1, OperationObligationSnapshot, OperationObligationComposer.
...
- **Dependencies/blockers:** P03; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
...
## CD-P04-02 — Compose from exact current owner snapshots
...
## CD-P04-03 — Revalidate snapshot identity at final sentry
...
## CD-P04-04 — Negative tests prove descriptor cannot authorize by possession
