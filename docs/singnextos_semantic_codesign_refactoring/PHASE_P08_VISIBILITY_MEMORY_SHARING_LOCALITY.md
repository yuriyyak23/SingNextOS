# P08 — Close visibility, Region, shared-mutation and semantic locality contracts

## 1. Goal
Close visibility, Region, shared-mutation and semantic locality contracts.

## 2. Rationale / live gap
- coherence/ownership/publication must remain separate.
- direct coherent output is currently future-gated.
...
- **NEW_PROPOSED:** `VisibilityClassV1`
- **NEW_PROPOSED:** `LocalityDomainV1`
- **NEW_PROPOSED:** `ContentionDomainV1`
- **NEW_PROPOSED:** `MutationAuthority extension only if proven necessary`
...
- Region state exploration for mutation/visibility/ABA.
