# ТЗ P08 — Close visibility, Region, shared-mutation and semantic locality contracts

**Depends on:** P07.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.
...
- **Verified current anchors:** `src/Runtime/SingPlus.Runtime/Regions/RegionAuthority.cs; src/Runtime/SingPlus.Runtime/Compute/ComputePlanner.cs; contracts/SingPlus.Contracts/ExternalOperations.cs`.
- **Proposed surface:** VisibilityClassV1, LocalityDomainV1, ContentionDomainV1, MutationAuthority extension only if proven necessary.
...
- **Dependencies/blockers:** P07; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
...
## CD-P08-03 — Design shared-mutable/atomic mutation authority inside RegionAuthority
...
## CD-P08-04 — semantic locality model without core/lane/NUMA IDs in authority API
