# ТЗ P16 — Prove SipJob refinement and add declarative OperationContract compiler without authority

**Depends on:** P15.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.
...
- **Verified current anchors:** `src/Runtime/SingPlus.Runtime/SipJobs/SipJobSegmentAdmission.cs; src/Runtime/SingPlus.Runtime/SipJobs/SipJobBarrierPlanner.cs; src/Runtime/SingPlus.Runtime/SipJobs/SipJobStageExecutionEligibility.cs; src/Runtime/SingPlus.Runtime/Tracing/TraceReplayEngine.cs`.
- **Proposed surface:** AuthorityVisibleTraceV1, OperationContractSchemaV1, OperationProtocolGenerator.
...
- **Dependencies/blockers:** P15; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
