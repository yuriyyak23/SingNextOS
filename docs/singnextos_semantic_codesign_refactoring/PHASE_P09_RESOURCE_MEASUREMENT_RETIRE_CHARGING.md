# P09 — Define resource measurement and charging across execute/replay/retire/provider overhead

## 1. Goal
Define resource measurement and charging across execute/replay/retire/provider overhead.

## 2. Rationale / live gap
- live accounting starts after submit; retire-only claim is false.
- measurement evidence must not mutate budget truth directly.
...
- **NEW_PROPOSED:** `ResourceMeasurementContractV1`
- **NEW_PROPOSED:** `ResourceChargingPolicyV1`
- **NEW_PROPOSED:** `RetireEvidenceClassV1`
...
- property proof of dimensional/settlement conservation.
