# ТЗ P06 — Compose authority, refinement, provider admission and CPU legality before submit

**Depends on:** P05.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.
...
- **Verified current anchors:** `src/Runtime/SingPlus.Runtime/VNext/ComputePlanResourceAdmission.cs; src/Runtime/SingPlus.Runtime/VNext/ResourceAdmissionProtocol.cs; src/Runtime/SingPlus.Runtime/ExternalOperations/ExternalOperationAuthority.cs; HybridCPU_ExternalRuntime.Contracts/ExternalOperationAdmissionBindingContracts.cs`.
- **Proposed surface:** SemanticExecutionAdmissionDecision, CoDesignRejectKind.
...
- **Dependencies/blockers:** P05; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
...
## CD-P06-02 — Bind refinement decision to exact binding generation
...
## CD-P06-03 — Single submit-start winner + pre-submit compensation
