# ТЗ P02 — Freeze semantic vocabulary and typed refinement algebra before DTOs

**Depends on:** P01.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.
...
- **Verified current anchors:** `contracts/SingPlus.Contracts/ExternalOperations.cs; contracts/SingPlus.Contracts/ComputePlanning.cs; contracts/SingPlus.Contracts/ResourceControlModelContracts.cs; contracts/SingPlus.Contracts/DeadlineCancellationContracts.cs`.
- **Proposed surface:** SemanticEffectClassV1, IsolationObligationV1, VisibilitySemanticsV1, ReplayDeterminismV1, SemanticRefinementEvaluator.
...
- **Dependencies/blockers:** P01; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
