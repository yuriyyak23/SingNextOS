# ТЗ P17 — Qualify one complete MatrixMultiply staged-output co-design contour

**Depends on:** P16.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.
...
- **Verified current anchors:** `contracts/SingPlus.Contracts/ComputePlanning.cs; src/Runtime/SingPlus.Runtime/Compute/ComputePlanner.cs; src/Runtime/SingPlus.Runtime/ExternalOperations/HybridCpuExternalOperationProvider.cs; HybridCPU_ExternalRuntime.Contracts/ExternalOperationAdapterContracts.cs`.
- **Proposed surface:** MatrixMultiply semantic effect, Matrix execution class, cross-repo guarantee provider.
...
- **Dependencies/blockers:** P16; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
