# ТЗ P12 — Close replay/determinism/provider refinement/isolation/contention/locality semantics

**Depends on:** P11.  **Baseline:** SingNextOS `1890a8e921cfe903b5b44857e4661168bf7bbceb`, HybridCPU-v2 `794c4a53494f503855ac8cf209efab23fde083b2`.

## CD-P12-01 — define replay/determinism lattice
...
- **Verified current anchors:** `HybridCPU_ExternalRuntime.Contracts/ExternalOperationReplayContracts.cs; HybridCPU_ISE/CloseToHSL/Core/Pipeline/Safety/SafetyVerifier.Types.cs; src/Runtime/SingPlus.Runtime/Compute/ComputePlanner.cs; src/Runtime/SingPlus.Runtime/Platform/PlatformAuthorityBridge.ExecutionPolicy.cs`.
- **Proposed surface:** ProviderBehaviorContractV1, DeterminismClassV1, IsolationClassSetV1, ContentionGuaranteeV1.
...
- **Dependencies/blockers:** P11; provider-specific enforcement remains BLOCKED if HybridCPU/provider cannot demonstrate the promised class.
...
## CD-P12-02 — provider behavior refinement including numeric semantics
...
## CD-P12-03 — typed isolation subset checks
...
## CD-P12-04 — guarantee-laundering and provider-class-switch tests
