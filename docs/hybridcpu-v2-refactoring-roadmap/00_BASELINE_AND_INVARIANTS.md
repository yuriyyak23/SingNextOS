...
**Immediate / documentation-and-test refactoring.** No new HybridCPU backend is required.
...
### 2. Add a repository-wide authority glossary

Before adding more provider interfaces, normalize terms used by tests and contracts:
...
The glossary can live in the whitebook or in this roadmap, but code and tests must use the same distinctions.
...
### 4. Introduce claim-status vocabulary for docs/tests

Use a common classification for features:
...
This is documentation/test metadata, not a runtime feature enum yet. Runtime feature discovery is Phase 1.
