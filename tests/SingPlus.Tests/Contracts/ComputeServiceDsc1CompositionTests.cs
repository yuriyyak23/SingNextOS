...
public sealed class ComputeServiceDsc1CompositionTests
{
        ...
        int destinationLength)
    {
        ...
        var descriptor = kernel.RegisterService(service, $"compute-{serviceId}", contract, protocol, IComputeServiceResponseProtocol.Definition).Value!;
        var session = kernel.OpenSession(requester, descriptor, [requesterCompute], capacity: 4);
